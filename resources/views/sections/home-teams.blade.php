<div class="team-area py-120">
    <div class="container">
            ...
            <div class="col-lg-6 mx-auto">
                <div class="site-heading text-center">
                            <span class="site-title-tagline"><i class="far fa-graduation-cap"></i>Nos
                                Formateurs</span>
                    <h2 class="site-title">Nos <span>Formateurs</span></h2>
                    <p>Nos formateurs qualifiés vous accompagneront tout au
        ...
        <div class="d-flex justify-content-center align-items-center">
            <a href="#" class="theme-btn">Voir plus<i class="fas fa-arrow-right-long"></i></a>
        </div>
    </div>
</div>
