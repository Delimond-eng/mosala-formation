        ...
        <div class="row">
            <div class="col-lg-6 mx-auto">
                <div class="site-heading text-center">
                    <span class="site-title-tagline"><i class="far fa-comment-alt-dots"></i> Temoignages</span>
                    <h2 class="site-title text-white">Ce que disent nos <span
                            class="text-capitalize">étudiants</span></h2>
                    <p class="text-white">Nos étudiants témoignent de l'impact positif de nos formations,
                        soulignant la clarté et la qualité du contenu, qui facilitent leur apprentissage et leur
