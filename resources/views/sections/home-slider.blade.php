<div class="hero-section">
    <div class="hero-slider owl-carousel owl-theme">
                    ...
                    <div class="col-md-12 col-lg-7">
                        <div class="hero-content">
                            ...
                            <h1 class="hero-title" data-animation="fadeInRight" data-delay=".50s">
                                Formation pratique sur <span>la TVA.</span>
                            </h1>
        ...
        <div class="hero-single" style="background: url(assets/img/students/slider-5.webp)">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-md-12 col-lg-7">
                        <div class="hero-content">
                            ...
                            <h1 class="hero-title" data-animation="fadeInRight" data-delay=".50s">
                                Formation pratique en <span>La sécurité Eléctronique</span>
                            </h1>
                            <p data-animation="fadeInLeft" data-delay=".75s">
                ...
                <div class="row align-items-center">
                    <div class="col-md-12 col-lg-7">
                        <div class="hero-content">
                            ...
                            <h1 class="hero-title" data-animation="fadeInRight" data-delay=".50s">
                                Formation sur l'utilisation <span>professionnelle del'IA</span>
                            </h1>
                            <p data-animation="fadeInLeft" data-delay=".75s">
