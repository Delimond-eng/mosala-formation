...
@section("content")
    <main class="main">
        ...
        <div class="site-breadcrumb" style="background: url(assets/img/students/page.avif)">
            <div class="container">
                <h2 class="breadcrumb-title">Foire Aux Questions</h2>
                    ...
                    <div class="col-lg-6">
                        <div class="faq-right">
                            <div class="site-heading mb-3">
                                <span class="site-title-tagline justify-content-start"><i class="far fa-graduation-cap"></i> Foire Aux Questions</span>
                                <h2 class="site-title my-3">Questions <span>fréquemment</span> posées générales.</h2>
                            </div>
